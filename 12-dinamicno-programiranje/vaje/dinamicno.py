...
def alternating_towers(h):
    ...
    def postavi_modro(h1):
        ...
        if h1 == h-2:
            return 0
        if h1 == h-3:
            return 1 + postavi_rdeco(h1+2)
        else: 
            return 1 + postavi_rdeco(h1+2) + postavi_rdeco(h1+3)

    def postavi_rdeco(h2):
        if h2 >= h:
            return 0
        if h2 == h-1:
            return 0
        if h2 == h-2:
            ...
            return 1 + postavi_modro(h2+1) + postavi_modro(h2+2)

    return postavi_rdeco(0) + postavi_modro(0)
...
articles = [("yoghurt", 0.39, 0.18), ("milk", 0.89, 1.03), ("coffee", 2.19, 0.2), ("butter", 1.49, 0.25), ("yeast", 0.22, 0.042), ("eggs", 2.39, 0.69), ("sausage", 3.76, 0.50),
 ("bread", 2.99, 1.0), ("Nutella", 4.99, 0.75), ("juice", 1.15, 2.0)]
